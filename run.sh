...
sentry-cli releases -o $SENTRY_ORG -p $SENTRY_PROJECT set-commits "my-new-release" --commit "Prithvirajkumar/node-playground@f5ba4c7270d3705fdd56bb970a7542f97f7f5ecc"
